...
public class EncodeDecodeTest {
    ...
    public void connectTest() {
        ...
        ConnectMessage message = new ConnectMessage(true, false, false, MQTTMessage.QoSLevel.LEAST_ONCE, true, true, 10,
                "Chii2 Client", "\\Chii2\\Server", "A Test Message", "longkerdandy", null);
